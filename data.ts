...
export const initialEQAResults: types.EQAResult[] = [
    {
        id: 'eqares-1',
        eqaMaterialId: 'eqa-1', // EQA Hóa sinh chu kỳ 2401
        testParameterId: 'tp-1', // Glucose
        ...
        recordedBy: 'User',
        notes: 'Kết quả tốt, Z-score thấp.'
    },
    {
        id: 'eqares-2',
        eqaMaterialId: 'eqa-1', // EQA Hóa sinh chu kỳ 2401
        testParameterId: 'tp-2', // ALT
        date: '2024-03-15T00:00:00Z',
        labValue: 45.2,
        peerGroupMean: 40.1,
        peerGroupSd: 2.5,
        ...
        recordedBy: 'User',
        notes: 'Kết quả cao hơn 2SD, cần xem xét lại quy trình.'
    }
];

export const initialEQASchedule: types.EQASchedule[] = [
    {
        id: 'eqasched-1',
        eqaMaterialId: 'eqa-1', // EQA Hóa sinh chu kỳ 2401
        sampleReceptionDate: '2024-07-25',
        resultDueDate: '2024-08-15',
        assignedPersonnelId: 'p-3', // Lê Văn C
        status: 'scheduled',
        notes: 'Chờ nhận mẫu từ Biorad.'
    },
    {
        id: 'eqasched-2',
        eqaMaterialId: 'eqa-2', // EQA Huyết học chu kỳ 2401
        sampleReceptionDate: '2024-07-28',
        resultDueDate: '2024-08-20',
        assignedPersonnelId: 'p-4', // Phạm Thị D
        status: 'scheduled',
    }
];


export const initialDecontaminationLogs: types.DecontaminationLog[] = [
    {
        id: 'decon-1',
        date: '2024-07-20',
        time: '16:30',
        areaOrEquipment: 'Tủ an toàn sinh học cấp 2 #1',
        method: 'Lau bề mặt, chiếu UV',
        chemicalUsed: 'Cồn 70%',
        contactTime: '30 phút',
        performedBy: 'Lê Văn C',
        notes: 'Khử nhiễm cuối ngày làm việc.'
    }
];

export const initialAssessments: types.Assessment[] = [
    {
        id: 'asm-1',
        title: 'Đợt đánh giá nội bộ T7/2024',
        assessor: 'Nguyễn Văn A',
        date: '2024-07-20',
        status: 'in_progress',
        findings: {
            '1.1': { criterionId: '1.1', status: 'Đạt', notes: 'Đã kiểm tra quyết định thành lập, đầy đủ chức năng nhiệm vụ.', evidence: [] },
            '1.2': { criterionId: '1.2', status: 'Không đạt', notes: 'Sơ đồ tổ chức chưa được cập nhật theo cơ cấu mới.', evidence: [] }
        }
    }
];

export const initialSystemEvents: types.SystemEvent[] = [
    { id: 'se-1', timestamp: new Date('2024-07-20T10:00:00Z').toISOString(), type: 'maintenance', description: 'Cập nhật phiên bản phần mềm lên v1.1.0', user: 'Quản trị viên', status: 'resolved' },
    { id: 'se-2', timestamp: new Date('2024-07-21T14:30:00Z').toISOString(), type: 'error', description: 'Hệ thống LIS không thể kết nối với máy AU480', user: 'Nhân viên Lab', status: 'open' },
    { id: 'se-3', timestamp: new Date('2024-07-22T02:00:00Z').toISOString(), type: 'backup', description: 'Hoàn thành sao lưu toàn bộ hệ thống hàng tuần', user: 'System', status: 'resolved' },
];
