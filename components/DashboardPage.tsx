...
import { Chemical, OnInstrumentStock, MonitoredArea, MonitoredEquipment, AreaEnvironmentLog, EquipmentTemperatureLog, WaterSource, WaterConductivityLog, WarehouseSubPage } from '../types';
...
interface DashboardPageProps {
  ...
  onNavigate: (page: WarehouseSubPage) => void;
}
