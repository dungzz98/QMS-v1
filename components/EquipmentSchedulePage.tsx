...
const EquipmentSchedulePage: React.FC<EquipmentSchedulePageProps> = ({ equipment, workItems, personnel, maintenanceLogs, onCheckTask, onExportToDoc }) => {
                                ...
                                <td key={day} className="border-r text-center align-middle p-0">
                                    <div className="w-full h-full flex items-center justify-center" title={personnelName}>
                                        <input
                                            type="checkbox"
                                            checked={!!log}
                                            onChange={() => onCheckTask(selectedEquipmentId, item.id, dateStr)}
