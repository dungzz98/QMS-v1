...
import EquipmentOperationPage from './EquipmentOperationPage';
...
interface EquipmentPageProps {
  ...
  onEditUsageLog: (log: EquipmentUsageLog) => void;
  onUpdateUsageLog: (log: Omit<EquipmentUsageLog, 'id'> | EquipmentUsageLog) => void;
  ...
  onCheckTask: (equipmentId: string, workItemId: string, date: string) => void;
  ...
  onUpdateProcedure: (equipmentId: string, procedure: string) => void;
}

type ActiveTab = 'list' | 'log' | 'schedule' | 'tasks' | 'workItemCatalog' | 'operation';
...
const EquipmentPage: React.FC<EquipmentPageProps> = (props) => {
  const { 
      ...
      onExportUsageLogToDoc, maintenanceChecklistLogs, onCheckTask, onExportMaintenanceSheetToDoc,
      accessLogs, onCreateNonConformity, onEditUsageLog, focusedItemId, onUpdateProcedure
  } = props;
    ...
    <div className="bg-white p-6 rounded-lg shadow-lg text-black">
      <div className="flex flex-wrap justify-between items-center mb-6 gap-4">
       ...
       <div className="flex flex-wrap gap-2 mb-4 border-b border-gray-200 pb-4">
            ...
            <TabButton tabId="operation" label="Quy trình Vận hành" icon={<WrenchScrewdriverIcon />} />
      ...
      <div>
        ...
        {activeTab === 'log' && (
          <EquipmentUsageLogPage
            ...
            onUpdateUsageLog={props.onUpdateUsageLog}
          />
        )}
        {activeTab === 'schedule' && (
